...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let png_image = ImageBuffer::<Rgb<u8>, Vec<u8>>::from_raw(21, 21, png_data)?;
    println!("🦀 fn to_png():                ✅");
    png_image.save("qrcode.png")?; // Save the PNG representation of the QRCode to a file called "qrcode1.png"
    ...
    fs::remove_file("qrcode.png")?; // Remove the file that was created after the test.
    ...
    println!("🦀 fn colorize():              ✅ ");
    image.save("qrcode_colorized.png")?; // Save the image to a file.
    ...
    fs::write("qrcode.svg", qrcode_svg); // Save the SVG representation of the QRCode to a file called "qrcode.svg"
    ...
    resized_image.save("qrcode_resized.png"); // Save the image to a file.
    ...
    fs::remove_file("qrcode_resized.png"); // Remove the file that was created after the test.
